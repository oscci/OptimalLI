...
consistent in -ize
data analysis suggests direct comparison between 2 fmri methods - should correlation matrix go in another supplement?
...
![Scatterplots of relationship between fTCD and two methods of fMRI laterality for MCA region. Spearman correlations with 95% CIs are shown as annotations.](images/Doppler_fmri2meth_MCA_2task.pdf){#fig-MCAscatter width="90%"}
